...
MarkdownFilesToHTML - Markdown Files to HTML
...
directly, they work hand-in-hand with a configuration file to determine the
default arguments and options passed to the keyword functions used in the app.
The default configuration settings can be over-ridden individually by the code.
